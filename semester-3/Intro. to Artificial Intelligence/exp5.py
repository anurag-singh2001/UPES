...
def MoveToUnvisited(ag, visited, goalLoc, dfsVisited):  # dfs to new safe room
   ...
   if curPos[1] + 1 <= 4 and (visited[curLoc + 1] == True or (curLoc + 1) == goalLoc) and dfsVisited[
       curLoc + 1] == False:
       ag.TakeAction ( 'Up' )
   ...
   if curPos[0] + 1 <= 4 and (visited[curLoc + 4] == True or (curLoc + 4) == goalLoc) and dfsVisited[
       curLoc + 4] == False:
       ag.TakeAction ( 'Right' )
       roomReachable = MoveToUnvisited ( ag, visited, goalLoc, dfsVisited )
       if roomReachable:
   ...
   if curPos[0] - 1 > 0 and (visited[curLoc - 4] == True or (curLoc - 4) == goalLoc) and dfsVisited[
       curLoc - 4] == False:
       ag.TakeAction ( 'Left' )
       roomReachable = MoveToUnvisited ( ag, visited, goalLoc, dfsVisited )
       if roomReachable:
   ...
   if curPos[1] - 1 > 0 and (visited[curLoc - 1] == True or (curLoc - 1) == goalLoc) and dfsVisited[
       curLoc - 1] == False:
       ag.TakeAction ( 'Down' )
       roomReachable = MoveToUnvisited ( ag, visited, goalLoc, dfsVisited )
       if roomReachable:
